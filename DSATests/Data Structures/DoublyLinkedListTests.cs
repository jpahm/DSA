...
// These tests are just LinkedListTests with a backwards enumerator test
...
namespace DSA.Tests
{
    ...
    public class DoublyLinkedListTests
    {
        ...
        [TestMethod()]
        public void BackwardsEnumeratorTest()
        {
            list = [1, 2, 3];

            int i = 3;
            foreach (int val in list.GetBackwardsEnumerable())
                Assert.AreEqual(i--, val);
